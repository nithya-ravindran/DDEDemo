...
public class Period_ implements Serializable
{
    ...
    private final static long serialVersionUID = 5934825521034558923L;
     ...
     * @param endDate
     */
    public Period_(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period_) == false) {
            return false;
        }
        Period_ rhs = ((Period_) other);
