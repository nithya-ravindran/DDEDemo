...
public class Period__ implements Serializable
{
    ...
    private final static long serialVersionUID = 445123581443337168L;
     ...
     * @param endDate
     */
    public Period__(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period__) == false) {
            return false;
        }
        Period__ rhs = ((Period__) other);
