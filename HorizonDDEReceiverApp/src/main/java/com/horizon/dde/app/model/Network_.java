...
public class Network_ implements Serializable
{
    ...
    private final static long serialVersionUID = 8429525773193576755L;
     ...
     * @param effectiveDate
     */
    public Network_(String code, String description, String parStatus, String effectiveDate, String endDate) {
        super();
        this.code = code;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Network_) == false) {
            return false;
        }
        Network_ rhs = ((Network_) other);
