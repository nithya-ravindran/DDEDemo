...
public class Period_____ implements Serializable
{
    ...
    private final static long serialVersionUID = -7734601077136622539L;
     ...
     * @param endDate
     */
    public Period_____(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period_____) == false) {
            return false;
        }
        Period_____ rhs = ((Period_____) other);
