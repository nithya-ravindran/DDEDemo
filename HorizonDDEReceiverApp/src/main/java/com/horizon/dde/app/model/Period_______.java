...
public class Period_______ implements Serializable
{
    ...
    private final static long serialVersionUID = 1131417777769945334L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public Period_______() {
    }
     ...
     * @param endDate
     */
    public Period_______(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period_______) == false) {
            return false;
        }
        Period_______ rhs = ((Period_______) other);
