...
public class Period________ implements Serializable
{
    ...
    private final static long serialVersionUID = 6368349188400730866L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public Period________() {
    }
     ...
     * @param endDate
     */
    public Period________(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period________) == false) {
            return false;
        }
        Period________ rhs = ((Period________) other);
