...
public class Period___ implements Serializable
{
    ...
    private final static long serialVersionUID = -6703293866260848794L;
     ...
     * @param endDate
     */
    public Period___(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period___) == false) {
            return false;
        }
        Period___ rhs = ((Period___) other);
