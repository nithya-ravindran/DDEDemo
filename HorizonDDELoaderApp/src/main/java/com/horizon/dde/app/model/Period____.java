...
public class Period____ implements Serializable
{
    ...
    private final static long serialVersionUID = 3665269437452375307L;
     ...
     * @param endDate
     */
    public Period____(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period____) == false) {
            return false;
        }
        Period____ rhs = ((Period____) other);
