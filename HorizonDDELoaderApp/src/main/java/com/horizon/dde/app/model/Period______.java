...
public class Period______ implements Serializable
{
    ...
    private final static long serialVersionUID = 3687333632805218236L;
     ...
     * @param endDate
     */
    public Period______(String startDate, String endDate) {
        super();
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Period______) == false) {
            return false;
        }
        Period______ rhs = ((Period______) other);
